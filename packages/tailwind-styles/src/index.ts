...
export const preset: ReturnType<typeof getPreset> = merge(
	getPreset({
		foundations: {
			color: {
				colorModes: {
					root: {
						darkModes: {
							...
							"fg-secondary-700":
								"var(--color-uui-gray-dark-mode-300)",
							/* text */
							"text-primary-900":
								"var(--color-uui-gray-dark-mode-25)",
							"text-primary_on-brand":
								"var(--color-uui-gray-dark-mode-50)",
							"text-secondary-700":
								"var(--color-uui-gray-dark-mode-50)",
							"text-secondary_hover":
								"var(--color-uui-gray-dark-mode-100)",
							"text-secondary_on-brand":
								"var(--color-uui-gray-dark-mode-100)",
							"text-tertiary-600":
								"var(--color-uui-gray-dark-mode-200)",
							"text-tertiary_hover":
								"var(--color-uui-gray-dark-mode-300)",
							"text-tertiary_on-brand":
								"var(--color-uui-gray-dark-mode-400)",
							/* buttons primary */
